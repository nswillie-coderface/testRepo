...
Making some new changes this are awesome please

%%Toggles
r.import = 1;
r.filter = 1;
r.plot = 0;
r.data_set = 1; %which data set to use
...
switch r.data_set
    case 1
        ...
        p.johnson_threshold = 50; %set johnson derivative threshold to identify johnson events
    ...
    case 2
        ...
        p.extenderEvent_size = 200; %size to make parallel port event tics for graphing
        p.johnson_threshold = 10; %set johnson derivative threshold to identify johnson events
        p.jEventMark_size = 200; %how big to make the event mark (for graphing)
        p.jOnset_multiplier = 50; %multiply the onset value by something for graphing
...
if r.import
    ...
    switch r.data_set
        case 1
            ...
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/epoc_256hz/matTones/FlexVal_IR_Extender_EPOC_2018.08.13_08.41.48.edf';
            
        case 2
            %1000 trials - fireface clicks - Extender w/ EPOC
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/epoc_256hz/fireface/FlexVal_eventMark_Fireface_IR_Extender_EPOC_1000_2018.08.15_12.41.41.edf';
        case 3
            %1000 trials - matTones - Extender w/ Flex
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/flex/matTones/FlexVal_IR_Extender_Flex_MatlabTones1000_2018.08.29_10.25.40.edf';
        case 4
            %1000 trials - fireface clicks - Extender w/ Flex
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/flex/fireface/FlexVal_eventMark_IR_Extender_Fireface_Flex_1000_2018.08.29_09.52.06.edf';
        case 5
            %1000 trials - matTones - Extender w/ EPOC
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/epoc_128hz/matTones/FlexVal_eventMark_IR_Extender_EPOC_128hz_matTones_2018.09.05_08.29.04.edf';
        case 6
            %1000 trials - fireface clicks - Extender w/ EPOC
            currentData = '/Users/mq43504108/Macquarie University/Nicholas Badcock - NikWilliams/Projects/FlexVal/data/event-marking_validation/extender_vs_IR/epoc_128hz/fireface/FlexVal_eventMark_IR_Extender_EPOC_128hz_fireface1000_2018.09.05_10.38.57.edf';
    end
...
extender_epoc_interval = [-250 250];
